...
export class Backend implements backendInterface {
    ...
    async clearTableOrders(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearTableOrders(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async confirmOrder(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createMenuItem(arg0: string, arg1: string, arg2: number, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getActiveKitchenOrders(): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getActiveKitchenOrders();
    ...
    async getOrderStatus(arg0: bigint): Promise<OrderStatus> {
        if (this.processError) {
            try {
                ...
                return from_candid_OrderStatus_n6(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getTableBill(arg0: bigint): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getTableBill(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTableOrders(arg0: bigint): Promise<Array<Order>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTableOrders(arg0);
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markOrderReady(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markOrderReady(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async payBill(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.payBill(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: bigint, arg1: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        items: value.items,
        estimatedMinutes: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.estimatedMinutes))
    };
}
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? OrderStatus.pending : "confirmed" in value ? OrderStatus.confirmed : "ready" in value ? OrderStatus.ready : value;
}
